...
FunctionsSection:AddButton({
    Name = "Copy Discord",
    Callback = function()
        setclipboard("https://discord.gg/dVy9vpRfHG")
    end
})
...
do
    ...
    game.StarterGui:SetCore("SendNotification", {
        Title = "YNC Scripts",
        Text = "MAKE SURE TO JOIN THE DISCORD",
        Duration = 1 / 0,
